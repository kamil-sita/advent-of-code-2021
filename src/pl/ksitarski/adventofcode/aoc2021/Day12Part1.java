...
public class Day12Part1 implements Solution {
    ...
    public long solve(List<String> lines) {
        ...
        while (analyzedPaths.size() > 0) {
            ...
            if (path.hasFinished()) {
                ...
                // commented out: actually not part of the question!
                //if (path.hasFinishedAndVisitedAllCaves()) {
                //    System.out.println("--> path was valid and visited all caves");
                //    finishedValidPaths.add(path);
                //}
                analyzedPaths.remove(path);
                continue;
    ...
    private static class Path {
        ...
        public boolean hasFinishedAndVisitedAllCaves() {
            return isValid() && hasFinished() && nodeMap.containsAllCaves(nodes);
        }
    ...
    private static class NodeMap {
        ...
        public boolean containsAllCaves(Collection<Node> nodes) {
            return nodes.containsAll(this.nodes);
        }
