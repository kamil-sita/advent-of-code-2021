...
public class Day4Part2 implements Solution {
    private static final int BINGO_SIZE = 5;

    public static void main(String[] args) {
        System.out.println(new Day4Part2().solve(Utils.readFile("day4.txt")));
    }
    ...
    private Utils.Pair<Bingo, Integer> findWinningBoardAndLastVal(List<Bingo> bingos, String[] vals) {
        ...
        for (String valAsString : vals) {
            ...
            bingos = bingos.stream()
                    .filter(bingo -> !bingo.updateBoardHasWon(val))
